class ServicesController < ApplicationController
  ...
  private  
    ...
    def service_params
      params.require(:service).permit(:service_type,:description, :is_recycle, :capacity_cubic_meters, :benchmark_load, :collection_rate, :density_of_waste, :year_installed, :site_id)
    end
end
